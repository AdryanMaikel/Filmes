...
function updateShadows() {
    ...
    scrollLeft > 0 ? shadow.classList.add("left") : shadow.classList.remove("left");
    scrollLeft < (carousel.scrollWidth - carousel.clientWidth) ? shadow.classList.add("right") : shadow.classList.remove("right");
}
